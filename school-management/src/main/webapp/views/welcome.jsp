...
<body>
	...
	%>
	<h2 style="margin-left: 630px; margin-top: 15px; margin-bottom: 7px; color: Black">User
	...
	<%
		...
		%>
	<h2 style="margin-left: 630px; margin-top: 15px; margin-bottom: 7px;  color: Black">Students
		Profile is listed below</h2>
	<table class="table table-dark table-hover">
		<thead>
			<tr>
